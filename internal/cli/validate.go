...
func Validate(output string, force, overwrite, stdoutFlag bool, files ...string) error {
	...
	return runFormat(os.Stdin, os.Stdout, output, force, overwrite, stdoutFlag, false, files...)
}
