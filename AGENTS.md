...
* `cmd/gorcs` is entirely generated by `go-subcommand` (v0.0.19). Logic should reside in `internal/cli`, and the `cmd/gorcs/*.go` files should delegate to functions in `internal/cli`.
